...
(
  ...
  log_session_id     varchar2(256),
  log_caller         varchar2(100)
)
;
...
comment on column LOGGER_LOG.log_level
  is 'The level of this log record';
...
comment on column LOGGER_LOG.log_session_id
  is 'The session ID that created this log record';
comment on column LOGGER_LOG.log_caller
  is 'The calling program that created this log record';
-- Drop sequence
